...
source <(curl -fsSL https://raw.githubusercontent.com/johanngrobe/ProxmoxVED/dev/paperless-to-lexoffice/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/johanngrobe/ProxmoxVED/dev/paperless-to-lexoffice/misc/tools.func)
...
source <(curl -fsSL https://raw.githubusercontent.com/johanngrobe/ProxmoxVED/dev/paperless-to-lexoffice/misc/tools.func) 2>/dev/null || {
