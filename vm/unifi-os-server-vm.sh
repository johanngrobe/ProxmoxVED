...
source /dev/stdin <<<$(curl -fsSL https://raw.githubusercontent.com/johanngrobe/ProxmoxVED/refs/heads/dev/paperless-to-lexoffice/misc/cloud-init.func) 2>/dev/null || true
