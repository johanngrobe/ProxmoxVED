...
source <(curl -fsSL https://raw.githubusercontent.com/johanngrobe/ProxmoxVED/refs/heads/dev/paperless-to-lexoffice/misc/api.func) 2>/dev/null
source <(curl -fsSL https://raw.githubusercontent.com/johanngrobe/ProxmoxVED/refs/heads/dev/paperless-to-lexoffice/misc/vm-core.func) 2>/dev/null
source <(curl -fsSL https://raw.githubusercontent.com/johanngrobe/ProxmoxVED/refs/heads/dev/paperless-to-lexoffice/misc/cloud-init.func) 2>/dev/null || true
load_functions
